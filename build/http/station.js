...
class Station extends tiny_typed_emitter_1.TypedEmitter {
    ...
    static async getInstance(api, stationData, ipAddress, listeningPort, enableEmbeddedPKCS1Support) {
        let publicKey;
        if (device_1.Device.isLock(stationData.device_type) && !device_1.Device.isLockWifiT85D2(stationData.device_type) && !device_1.Device.isLockWifiT8506(stationData.device_type) && !device_1.Device.isLockWifiT8502(stationData.device_type) && !device_1.Device.isLockWifiT8510P(stationData.device_type, stationData.station_sn) && !device_1.Device.isLockWifiT8520P(stationData.device_type, stationData.station_sn)) {
    ...
    lockDevice(device, value) {
        ...
        if (device.isLockBleNoFinger() || device.isLockBle()) {
            ...
            logging_1.rootHTTPLogger.debug("Station lock device - Locking/unlocking device (nested payload)...", { station: this.getSerial(), device: device.getSerial(), admin_user_id: this.rawStation.member.admin_user_id, payload: command, nestedPayload: nestedPayload });
        ...
        else if (device.isLockWifiT8506() || device.isLockWifiT8502() || device.isLockWifiT8510P() || device.isLockWifiT8520P() || device.isLockWifiT85D2()) {
    ...
    setSmartLockParams(device, property, value) {
        ...
        if (device.isLockWifiT8506() || device.isLockWifiT8502() || device.isLockWifiT8510P() || device.isLockWifiT8520P() || device.isLockWifiT85D2()) {
            let payload;
            switch (property) {
                case types_1.PropertyName.DeviceWrongTryProtection:
    ...
    setNotification(device, value) {
        ...
        else if (device.isLockWifiT8506() || device.isLockWifiT8502() || device.isLockWifiT8510P() || device.isLockWifiT8520P() || device.isLockWifiT85D2() || device.isLockWifiR10() || device.isLockWifiR20()) {
            let oldvalue = 0;
    ...
    getLockParameters() {
        ...
        if (device_1.Device.isLockWifiT8506(this.getDeviceType()) || device_1.Device.isLockWifiT85D2(this.getDeviceType()) || device_1.Device.isLockWifiT8502(this.getDeviceType()) || device_1.Device.isLockWifiT8510P(this.getDeviceType(), this.getSerial()) || device_1.Device.isLockWifiT8520P(this.getDeviceType(), this.getSerial())) {
